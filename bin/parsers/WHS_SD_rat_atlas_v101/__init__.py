...
if __name__=='__main__':
    try:
        ...
        inputDirectory  = \
        'atlases/WHS_SD_rat_atlas_v101/src/MBAT_WHS_SD_rat_atlas_v1.01/start_atlas/WHS_SD_rat_atlas_v1.01.atlas'
        outputDirectory = 'atlases/WHS_SD_rat_atlas_v101/caf/'
